package com.tilawah.android.audio
 ...
 *
 * Implementations throw [com.tilawah.android.app.AppError.AudioPermissionDenied]
 * when `RECORD_AUDIO` is not granted and
 * [com.tilawah.android.app.AppError.AudioRecordingFailed] for
